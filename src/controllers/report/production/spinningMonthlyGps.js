// Spinning Monthly GPS report.
// Mirrors rptSpinningMonthlyGPS.rdlc — per count (grouped by branch): production,
// standard / actual GPS, GPS with power-cut, GPS efficiency and 40s conversions.
//
// SP: sp_Prodn_Spinning_MonthlyGPS (CompanyCode, FromDate, ToDate)
...
const TITLE = 'SPINNING MONTHLY GPS';
const FILE_NAME = 'SpinningProduction_MonthlyGPS';
...
export const spinningMonthlyGpsReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_Spinning_MonthlyGPS', fileName: FILE_NAME, buildDocDefinition });
