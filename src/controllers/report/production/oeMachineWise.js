// OE Machine Wise Production report.
// Mirrors 03rptOEProductionMachineWise.rdlc — one row per machine with
...
const TITLE = 'OE MACHINE WISE PRODUCTION';
const FILE_NAME = 'OEProduction_MachineWise';
...
export const oeMachineWiseReport = (req, res) => {
