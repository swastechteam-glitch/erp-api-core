// Breaker Drawing Production Shift Wise Details report.
// Mirrors rptDrawingProductionShiftWise_Details.rdlc — like Shift Wise but with
// the Employee Name and the extra Index / Energy / UKG / Sliver Break columns.
//
...
const TITLE = 'BREAKER DRAWING PRODUCTION - SHIFT WISE DETAILS';
const FILE_NAME = 'DrawingProduction_ShiftWiseDetails';
...
export const drawingShiftWiseDetailsReport = (req, res) =>
