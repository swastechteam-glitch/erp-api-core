// OE Shift Wise Details report.
// Mirrors rptOEProductionShiftWiseDetails_Arun.rdlc — like Shift Wise but
...
const TITLE = 'OE SHIFT WISE PRODUCTION REPORT (DETAILED)';
const FILE_NAME = 'OEProduction_ShiftWiseDetails';
...
export const oeShiftWiseDetailsReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_OEProdnDetails_GetAll', fileName: FILE_NAME, buildDocDefinition });
