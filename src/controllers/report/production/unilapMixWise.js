// Uni Lap Production Details (Mix Wise) report.
// Mirrors rptUniLapMixWiseDetails_report.rdlc — one row per Mixing with Opening
// + per-shift production + Total + Upto Date, plus a grand-total row.
//
// SP: sp_Prodn_UniLap_ShiftMixWise (CompanyCode, FromDate, ToDate[, ShiftCode])
...
const TITLE = 'UNILAP PRODUCTION DETAILS (MIX WISE)';
const FILE_NAME = 'UnilapProduction_MixWise';
...
export const unilapMixWiseReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_UniLap_ShiftMixWise', fileName: FILE_NAME, buildDocDefinition });
