// OE Machine Wise Summary (Day) report.
// Mirrors rptOEMachineWiseDetails_report.rdlc — one row per machine with
// per-shift on-date production, total + upto-date production, and utilisation /
// waste % totals.
//
// SP: sp_Prodn_OE_OverAll (CompanyCode, FromDate, ToDate)
...
const TITLE = 'OE PRODUCTION DETAILS (MACHINE WISE)';
const FILE_NAME = 'OEProduction_MachineWiseSummary';
...
export const oeOverAllMachineWiseReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_OE_OverAll', fileName: FILE_NAME, buildDocDefinition });
