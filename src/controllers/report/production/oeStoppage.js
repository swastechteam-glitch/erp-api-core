// OE Stoppage Wise report.
// Mirrors 05rptOEProductionStoppage.rdlc — one row per stoppage reason, with
// HRS and % columns for each shift, plus on-date and upto-date totals.
//
// SP: sp_Prodn_OE_Stoppage (CompanyCode, FromDate, ToDate)
...
const TITLE = 'OE STOPPAGE REPORT';
const FILE_NAME = 'OEProduction_StoppageWise';
...
export const oeStoppageReport = (req, res) => {
  return runReport(req, res, {
    spName: 'sp_Prodn_OE_Stoppage',
    fileName: FILE_NAME,
    buildDocDefinition
  });
};
