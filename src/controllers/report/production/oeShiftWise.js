// OE Shift Wise Production report.
// Mirrors 01rptOEProductionShiftWise.rdlc — detail rows grouped per shift,
...
const TITLE = 'OE SHIFT WISE PRODUCTION REPORT';
const FILE_NAME = 'OEProduction_ShiftWise';
...
export const oeShiftWiseReport = (req, res) => {
