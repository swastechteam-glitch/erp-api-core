// OE Day Wise (Count Wise) Production Summary report.
// Mirrors 02rptOEProductionDayWise.rdlc — production grouped by count + mixing.
//
...
const TITLE = 'OE DAY WISE PRODUCTION REPORT';
const FILE_NAME = 'OEProduction_Summary';
...
// Aggregate oe detail rows by Count + Mixing for the count/day-wise views.
...
export const oeProductionSummaryReport = (req, res) => {
