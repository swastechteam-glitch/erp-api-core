// OE vs Ultimo difference report.
// Mirrors rptOEvsUltimodata.rdlc — per machine: ERP production, machine
...
const TITLE = 'OE & ULTIMO DIFFERENCE';
const FILE_NAME = 'OEVsUltimo';
...
export const oeUltimoDifferenceReport = (req, res) =>
