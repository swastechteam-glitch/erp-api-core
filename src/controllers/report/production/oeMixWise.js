// OE Production Details (Mix Wise) report.
// Mirrors rptOEMixWiseDetails_report.rdlc — one row per Mixing with Opening
// + per-shift production + Total + Upto Date, plus a grand-total row.
//
// SP: sp_Prodn_OE_ShiftMixWise (CompanyCode, FromDate, ToDate)
...
const TITLE = 'OE PRODUCTION DETAILS (MIX WISE)';
const FILE_NAME = 'OEProduction_MixWise';
...
export const oeMixWiseReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_OE_ShiftMixWise', fileName: FILE_NAME, buildDocDefinition });
