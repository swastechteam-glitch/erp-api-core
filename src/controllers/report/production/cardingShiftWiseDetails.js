// Carding Production Shift Wise Details report.
// Mirrors rptCardingProductionShiftWise_Details.rdlc — like Shift Wise but with
// the Employee Name and the extra Energy / UKG / Sliver Break columns.
//
...
// 13 columns: M/C No, Mixing, Employee Name, Working Mins, Speed, Target Prodn,
// ACT Prodn, Stop Time, Eff %, UT %, Energy, UKG, Sliver Break.
const WIDTHS = [34, '*', '*', 48, 44, 48, 48, 44, 40, 40, 44, 44, 48];

const TITLE = 'CARDING PRODUCTION - SHIFT WISE DETAILS';
const FILE_NAME = 'CardingProduction_ShiftWiseDetails';

const HEADERS = ['M/C No', 'Mixing', 'Employee Name', 'Working Mins', 'Speed (MPM)', 'Target Prodn', 'ACT Prodn', 'Stop Time', 'Eff %', 'UT %', 'Energy', 'UKG', 'Sliver Break'];
...
export const cardingShiftWiseDetailsReport = (req, res) =>
