// Spinning Production Loss report.
// Mirrors rptSpinningLoss.rdlc — per count: machines, GPS (on-date / upto-date),
// standard & actual production and the average production per day.
//
// SP: sp_Prodn_Spinning_Loss (CompanyCode, FromDate, ToDate)
...
const TITLE = 'SPINNING PRODUCTION LOSS REPORT';
const FILE_NAME = 'SpinningProduction_Loss';
...
export const spinningLossReport = (req, res) =>
  runReport(req, res, { spName: 'sp_Prodn_Spinning_Loss', fileName: FILE_NAME, buildDocDefinition });
