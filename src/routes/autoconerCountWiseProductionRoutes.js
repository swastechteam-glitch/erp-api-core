...
import {
  ...
  update,
  remove,
} from "../controllers/autoconerCountWiseProduction.controller.js";
import { authenticate } from "../middleware/authMiddleware.js";

const router = express.Router();

// AutoConer Count Wise Production Entry
// (frmAutoConerCountWiseProduction / frmAutoconerCountwiseProductionDetails)
router.get("/options", authenticate, getOptions);
router.get("/next-no", authenticate, getNextNo);
router.get("/load", authenticate, loadCountProduction);
